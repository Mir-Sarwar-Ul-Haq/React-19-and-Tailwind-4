...
const Navbar = ({ activePage, handleNavClick, isNavOpen, toggleNav }) => {
  return (
    <>
      <div
        className={`2xl:w-80 xl:w-52 w-44 h-full bg-[#f8f8f8] flex flex-col justify-between pt-6 pl-6 pb-14 md:pb-0 absolute md:relative z-10 transition-transform duration-300 ${
      ...
      >
        ...
        <div className="flex justify-between pr-6 pb-2">
          ...
          <a href="#">
            <i className="bx bxl-twitter text-2xl text-blue-400 "></i>
          </a>
          <a href="#">
